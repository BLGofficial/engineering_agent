...
function GlassCard({ children, className = "", glow = false, style }: { children: React.ReactNode; className?: string; glow?: boolean; style?: React.CSSProperties }) {
  return (
    <div
      style={style}
      className={`bg-white/5 backdrop-blur-2xl border border-orange-500/40 rounded-lg sm:rounded-2xl shadow-lg sm:shadow-2xl transition-all duration-500 hover:border-orange-400/70 hover:bg-white/8 hover:shadow-lg sm:hover:shadow-2xl ${
...
function PipelineStep({
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 animate-fade-in">
      <div
        className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center font-bold text-xs transition-all duration-500 ${
          status === "complete"
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse-glow" style={{ animationDuration: "8s" }} />
        <div className="absolute bottom-1/3 right-1/4 w-56 sm:w-80 h-56 sm:h-80 bg-orange-400/8 rounded-full blur-3xl animate-pulse-glow" style={{ animationDuration: "10s", animationDelay: "2s" }} />
        <div className="absolute top-1/2 left-1/2 w-48 sm:w-72 h-48 sm:h-72 bg-orange-500/8 rounded-full blur-3xl animate-pulse-glow" style={{ animationDuration: "12s", animationDelay: "4s" }} />
      </div>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row h-screen overflow-hidden">
        ...
        {/* Sidebar */}
        <div
          className={`fixed lg:static w-64 h-screen border-r border-orange-500/20 bg-black flex flex-col overflow-y-auto transition-all duration-300 z-40 ${
        ...
        >
          ...
          {/* AI Engineer Card */}
          <div className="p-3 sm:p-4 m-3 sm:m-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              ...
              <GlassCard className="p-4 sm:p-8 animate-slide-up" glow>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mt-3 sm:mt-4">
                  ...
                  <button
                    ...
                    className={`w-full sm:w-auto flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm transition-all duration-300 ${
                      loading || !input.trim()
              ...
              {loading && (
                <GlassCard className="p-8 sm:p-12 flex justify-center animate-slide-up" glow>
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-xs sm:text-sm text-orange-200 font-semibold text-center">Engineering your role with Kimi AI...</p>
                  </div>
                </GlassCard>
              )}
                  ...
                  <GlassCard className="p-4 sm:p-8 border-orange-400/50 bg-gradient-to-r from-orange-500/20 to-orange-400/10 animate-slide-up" glow>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm transition-all duration-300 ${
                          downloading
                            ? "bg-orange-950/60 text-orange-200/40 cursor-not-allowed"
                            : "bg-gradient-to-r from-orange-500 to-orange-600 text-white hover:shadow-2xl hover:shadow-orange-500/50 hover:scale-105 active:scale-95 animate-pulse-glow"
                        }`}
